"""QuickSwap (Uniswap V2 fork) DEX adapter."""
...
class QuickSwap(DEX):
    """QuickSwap (Uniswap V2 fork) adapter."""

    def __init__(self, router_address: str, name: str = "QuickSwap"):
        """
        Initialize QuickSwap adapter.

        Args:
            router_address: QuickSwap router contract address
            name: DEX name
        """
